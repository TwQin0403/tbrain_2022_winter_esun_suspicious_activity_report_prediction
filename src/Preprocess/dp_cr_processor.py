...
dp_cr_processor: 定義porcessor class
"""
import pandas as pd
...
def compute_templete_feats(dp, dp_type):
    ...
    cols = [
        'cust_id', 'date', 'tx_amt_twd_count_cr', 'tx_amt_twd_sum_cr',
        'tx_amt_twd_median_cr', 'ATM_count_cr', 'ATM_mean_cr', 'ATM_sum_cr',
        'cross_bank_count_cr', 'cross_bank_mean_cr', 'cross_bank_sum_cr'
    ]
    cols = ['cust_id', 'date'
